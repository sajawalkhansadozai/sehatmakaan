...
import '../../features/bookings/screens/admin/tabs/bookings_tab.dart';
import '../../features/workshops/screens/admin/tabs/workshops_tab.dart';
import '../../features/workshops/screens/admin/tabs/workshop_creators_tab.dart';
import 'tabs/marketing_tab.dart';
import 'dialogs/doctor_dialogs.dart';
import '../../features/bookings/screens/admin/dialogs/booking_dialogs.dart';
import '../../features/workshops/screens/admin/dialogs/workshop_dialogs.dart';
...
class _AdminDashboardPageState extends State<AdminDashboardPage> {
        ...
        .listen((snapshot) {
          if (mounted) {
            setState(() {
              _workshops.clear();
              for (var doc in snapshot.docs) {
                _workshops.add({'id': doc.id, ...doc.data()});
              }
            });
          }
        });
  ...
  Future<void> _rejectDoctorMutation(
    ...
    await _mutationsService.rejectDoctor(doctor, reason);
    await _loadDoctors(); // Refresh data
  ...
  Future<void> _suspendDoctorMutation(Map<String, dynamic> doctor) async {
    ...
    await _mutationsService.suspendDoctor(doctor);
    await _loadDoctors(); // Refresh data
