      ...
      if (userType == 'admin') {
        ...
        if (userId.isNotEmpty) {
          try {
            ...
            // Check if account is suspended, rejected, or inactive
            if (status == 'suspended' || status == 'rejected' || !isActive) {
              debugPrint('⛔ Account blocked - Redirecting to suspension page');
              // Account suspended/rejected/inactive - logout and redirect
              await prefs.clear();
