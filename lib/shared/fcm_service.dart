...
class FCMService {
  ...
  Future<void> initialize(String userId) async {
    try {
      // Skip FCM token operations on web (service worker issues)
      if (kIsWeb) {
  ...
  Future<void> subscribeToTopic(String topic) async {
    // Skip topic subscription on web (not supported)
    if (kIsWeb) {
      debugPrint('⚠️ Topic subscription skipped on web: $topic');
      return;
    }
  ...
  Future<void> unsubscribeFromTopic(String topic) async {
    // Skip topic operations on web (not supported)
    if (kIsWeb) {
      debugPrint('⚠️ Topic unsubscription skipped on web: $topic');
      return;
    }
